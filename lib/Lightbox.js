...
var Lightbox = function (_Component) {
  ...
  _createClass(Lightbox, [{
    ...
    key: "renderImage",
    value: function renderImage(image, params) {
      return _react2.default.createElement("img", {
        className: (0, _aphrodite.css)(this.classes.image, this.state.imageLoaded && this.classes.imageLoaded),
        onClick: this.props.onClickImage,
        sizes: params.sizes,
        alt: image.alt,
        src: image.src,
        srcSet: params.sourceSet,
        style: {
          cursor: this.props.onClickImage ? "pointer" : "auto",
          maxHeight: "calc(100vh - " + params.heightOffset + ")"
        }
      });
    }
  }, {
